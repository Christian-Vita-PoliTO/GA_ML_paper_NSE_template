...
does not. An ablation on the same data and with the same reduced training
protocol, reported in Table~\ref{tab:ablation}, measures what each level of the
hierarchy contributes.
